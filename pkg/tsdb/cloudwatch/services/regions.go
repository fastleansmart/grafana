...
func mergeEC2RegionsAndConstantRegions(regions map[string]struct{}, ec2Regions []ec2v2types.Region) {
...
func (r *RegionsService) GetRegions(ctx context.Context) ([]resources.ResourceResponse[resources.Region], error) {
	...
	ec2Regions, err := r.DescribeRegions(ctx, &ec2v2.DescribeRegionsInput{})
