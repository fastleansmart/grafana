...
import (
	...
	oam2 "github.com/aws/aws-sdk-go-v2/service/oam"
	oam2types "github.com/aws/aws-sdk-go-v2/service/oam/types"
...
func (a *AccountsService) GetAccountsForCurrentUserOrRole(ctx context.Context) ([]resources.ResourceResponse[resources.Account], error) {
	...
	sinks := []oam2types.ListSinksItem{}
	for {
		response, err := a.ListSinks(ctx, &oam2.ListSinksInput{NextToken: nextToken})
		if err != nil {
	...
	nextToken = nil
	for {
		links, err := a.ListAttachedLinks(ctx, &oam2.ListAttachedLinksInput{
