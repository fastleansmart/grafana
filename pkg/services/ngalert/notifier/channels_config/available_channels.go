		...
		{ // Since Grafana 11.6
			...
			Options: []NotifierOption{
				...
				},
				{
					...
					InputType:    InputTypePassword,
					PropertyName: "password",
					Description:  "Password to use for Jira authentication. Go to https://id.atlassian.com/manage-profile/security/api-tokens to obtain a token.",
					Secure:       true,
					Required:     true,
				},
				{
				...
				},
				{
					...
					Description:  `Name of the workflow transition to resolve an issue. The target status must not have the category "done".`,
					Element:      ElementTypeInput,
					InputType:    InputTypeText,
					Placeholder:  "",
